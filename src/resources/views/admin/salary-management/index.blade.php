...
<div class="space-y-6">
    ...
    <div class="grid gap-5 lg:grid-cols-2">
        ...
        <section class="rounded-2xl border border-blue-100 bg-blue-50 p-6"><h2 class="text-lg font-bold text-blue-900">Kaedah Pengiraan Gaji Sesi</h2><div class="mt-5 space-y-4 text-sm leading-7 text-blue-900"><p><strong>Tabung gaji harian</strong><br>Jumlah gaji RM semua staf hadir</p><p><strong>Gaji setiap staf</strong><br>Amaun RM yang dimasukkan untuk staf tersebut</p><p>Peratus gaji sesi = jumlah gaji ÷ Net Sales sesi × 100. Hanya staf yang hadir dikira. Jika tiada kehadiran, pengiraan ditahan untuk semakan.</p></div></section>
    </div>
