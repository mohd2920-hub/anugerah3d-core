...
<div style="padding:24px;background-color:#166534;">
<img src="{{ asset('images/anugerah3d-official-logo.png') }}" alt="Anugerah3D" style="height:auto;display:block;max-width:170px;height:auto;margin-bottom:22px;">
<div style="display:inline-block;padding:6px 10px;border-radius:999px;background-color:#14532d;color:#dcfce7;font-size:11px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;">Bayaran berjaya</div>
