    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 12px 32px rgba(23,50,77,.12);">
        <tr>
            <td style="background:linear-gradient(135deg,#17324d,#285875);padding:30px 30px 34px;text-align:center;color:#ffffff;">
                <img src="{{ $logoUrl }}" width="92" alt="Anugerah3D" style="height:auto;display:block;margin:0 auto 18px;border-radius:0;border:3px solid rgba(255,255,255,.8);object-fit:contain;">
            ...
            <td style="padding:28px 30px;">
                ...
                @if($template->video_path)
                    <div style="margin-top:20px;text-align:center;">
                        <a href="{{ asset($template->video_path) }}" target="_blank" style="display:inline-block;background:#17324d;color:#ffffff;padding:14px 24px;border-radius:10px;text-decoration:none;font-weight:bold;">▶ Tonton Video</a>
                        <p style="font-size:13px;color:#64748b;">Tekan butang untuk membuka video dalam pelayar.</p>
                    </div>
                @endif
