...
<tr><td style="background:#17324d;padding:26px;text-align:center;color:#fff;"><img src="{{ $logoUrl }}" width="72" alt="Anugerah3D" style="height:auto;display:block;margin:0 auto 14px;border-radius:0;object-fit:contain;"><div style="font-size:11px;letter-spacing:1.8px;text-transform:uppercase;color:#fdba74;font-weight:800;">Admin notification</div><h1 style="margin:9px 0 5px;font-size:24px;">New agent pending approval</h1><p style="margin:0;color:#cbd5e1;font-size:13px;">A new referral registration requires review.</p></td></tr>
