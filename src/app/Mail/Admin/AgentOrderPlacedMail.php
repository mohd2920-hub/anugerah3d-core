    ...
    public function content(): Content
    {
        $order = Order::query()
            ->with([
                ...
                'items:id,order_id,product_code,product_name,quantity,clicker_character_count,clicker_characters,clicker_casing_image_path,clicker_huruf_image_path,unit_selling_price,discount_percentage,unit_price,line_total,is_preorder',
            ])
