...
class AgentEmailTemplateController extends Controller
{
    ...
    public function store(
        SaveAgentEmailTemplateRequest $request,
        SyncAgentEmailTemplateImages $syncAgentEmailTemplateImages,
    ): RedirectResponse {
        $template = DB::transaction(function () use ($request, $syncAgentEmailTemplateImages): AgentEmailTemplate {
    ...
    public function update(
        SaveAgentEmailTemplateRequest $request,
        AgentEmailTemplate $agentEmailTemplate,
        SyncAgentEmailTemplateImages $syncAgentEmailTemplateImages,
    ): RedirectResponse {
        DB::transaction(function () use ($request, $agentEmailTemplate, $syncAgentEmailTemplateImages): void {
            $agentEmailTemplate->fill($request->templateData())->save();
            $syncAgentEmailTemplateImages->handle(
                $agentEmailTemplate,
